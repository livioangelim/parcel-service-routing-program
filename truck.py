...
class Truck:
    ...
    def load_packages(self, packages):
        ...
        for package in packages:
            if len(self.packages) < self.MAX_CAPACITY:
                ...
                print(f"Package {package.package_id} loaded onto Truck {self.truck_id}.")
            else:
    ...
    def deliver_packages(self, distance_data):
        ...
        self.current_location = '4001 South 700 East'  # Use the hub's actual address
        ...
        while unvisited:
            ...
            if next_package:
                ...
                print(f"Delivered Package {next_package.package_id} at {self.time.strftime('%I:%M %p')}.")
